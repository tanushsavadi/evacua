...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "rounded-lg border border-[var(--color-line-subtle)] bg-[var(--color-bg-panel)] text-[var(--color-text-primary)] shadow-[0_24px_80px_-48px_rgba(0,0,0,0.9)]",
        className,
      )}
      {...props}
    />
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-xs leading-relaxed text-[var(--color-text-muted)]", className)}
      {...props}
    />
  );
}
